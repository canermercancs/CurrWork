...
for curr_epoch = prev_epoch:prev_epoch+num_epochs-1
    ...
    [params_next, y_target, H_classifier_next, H_clampeds, H_frees, y_frees] = ...
        trainHCRF_epoch2(curr_epoch, train_bags, train_labels, ...
...
function writeEpoch2File()
    ...
    save(props.fullname, 'params_all', 'models_all', 'hyperparams', 'props', 'params_next', ...
        'H_classifier_next', 'sampling_perf', 'infer_perf', 'curr_cv', 'curr_vd', 'curr_epoch', ...
        'H_classifiers_all', 'H_clampeds_all', 'H_frees_all', 'y_frees_all', 'y_target');
end
